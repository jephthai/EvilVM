...
** TODO Chain compilers together for safety
...
* Code quality [/] [%]
** TODO ICMP and HTTP transports have same structure
...
** TODO Rewrite the main server more abstractly and without using a Queue
