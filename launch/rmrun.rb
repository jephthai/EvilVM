...
if ARGV.length != 5
  ...
  puts("   payload, load it into executable memory, and execute it in a thread.  The")
  puts("   user is responsible to provide the webserver where the payload can be")
  puts("   downloaded.  Uses the 'winrm' ruby gem.")
  puts("")
  puts(" Example:")
  puts("")
